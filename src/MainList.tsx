...
export function MainList() {
  return (
    <section class="my-5 font-philosopher -lg:w-0 -md:mt-20">
      <div class="-md:w-[calc(100vw-2rem)] -lg:w-[calc(50vw)] my-5 text-2xl flex items-center gap-3">
        <img src={searchIcon} class="max-w-10" />
        <div>Знайдемо одяг, який відповідає твоїм побажанням</div>
      </div>
      <div class="-lg:w-[calc(100vw-2rem)] my-5 text-2xl flex items-center gap-3">
